    ...
    <>
      <ErrorBoundary>
        <div
          ...
          style={videoEnded ? { display: "block" } : { display: "none" }}
        >
          <div className="message-wrap">
            ...
            <div className="donate-message">
              <p>
                There's still time left. Indigenous peoples and local
                communities are fighting for climate justice. Join them.
              </p>
              <a
                className="button"
      ...
      <div
        ...
        style={videoLoading ? { display: "flex" } : { display: "none" }}
      >
        <aside>
          <div className="frame">
      ...
      {!videoEnded && (
        <div className="video-background">
          <ReactPlayer
            url={
              isSafari
                ? "https://player.vimeo.com/video/728786848?h=6c4f02223e"
                : [
                    { src: "video/End-Game-Cut-Scene.mp4", type: "video/mp4" },
                    {
                      src: "video/End-Game-Cut-Scene-Lolores.webm",
                      type: "video/webm",
                    },
                  ]
            }
