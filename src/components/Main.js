  ...
  return (
    <main>
      <aside className="banner">
        <img
          id="sligoil-ad"
          src={require("../assets/images/sligoil-banner-2.gif")}
          alt="Sligoil: Your Power Is In Our Hands"
        />
      </aside>
      <header className="banner" id="title">
        <h1>
          <img
            src={require("../assets/images/crypto-transfer-logo-texture.gif")}
            alt="crypto-transfer"
          />
        </h1>
      </header>
        ...
        <div className="transfer-wrap">
          <section className="intro">
            ...
            <ul>
              ...
              <li>
                Transferred funds will probably reach the intended recipient
              </li>
      ...
      <aside className="banner">
        <img
          src={require("../assets/images/vox-ad-2.gif")}
          alt="You Are Being Watched"
        />
      </aside>
    </main>
  );
